...
def calculate_wins(scratchcard):
    return sum(num in scratchcard["winning_nums"] for num in scratchcard["selected_nums"])
...
def get_scratchcard_scores(file, *, use_points = True):
    ...
    return {scratchcard['card_id']: totalling_function(scratchcard) for scratchcard in scratchcards }
